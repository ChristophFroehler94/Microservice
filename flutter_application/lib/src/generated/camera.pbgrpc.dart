...
class CameraServiceClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$0.StatusReply> zoom(
    $0.ZoomRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  $grpc.ResponseStream<$0.TsChunk> streamTs(
    $0.StreamH264Request request, {
    $grpc.CallOptions? options,
  }) {
    return $createStreamingCall(
        _$streamTs, $async.Stream.fromIterable([request]),
        options: options);
  }

  $grpc.ResponseFuture<$0.SnapshotReply> takeSnapshot(
  ...
  static final _$getStatus = $grpc.ClientMethod<$1.Empty, $0.CameraStatus>(
      ...
      $0.CameraStatus.fromBuffer);
  static final _$streamTs =
      $grpc.ClientMethod<$0.StreamH264Request, $0.TsChunk>(
          '/camera.v1.CameraService/StreamTs',
          ($0.StreamH264Request value) => value.writeToBuffer(),
          $0.TsChunk.fromBuffer);
  static final _$takeSnapshot =
      $grpc.ClientMethod<$0.SnapshotRequest, $0.SnapshotReply>(
          '/camera.v1.CameraService/TakeSnapshot',
          ($0.SnapshotRequest value) => value.writeToBuffer(),
          $0.SnapshotReply.fromBuffer);
}
...
abstract class CameraServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.StatusReply> power_Pre(
      $grpc.ServiceCall $call, $async.Future<$0.PowerRequest> $request) async {
    return power($call, await $request);
  }

  $async.Future<$0.StatusReply> power(
      $grpc.ServiceCall call, $0.PowerRequest request);

  $async.Future<$0.StatusReply> zoom_Pre(
      $grpc.ServiceCall $call, $async.Future<$0.ZoomRequest> $request) async {
  ...
  $async.Future<$0.CameraStatus> getStatus(
      $grpc.ServiceCall call, $1.Empty request);

  $async.Stream<$0.TsChunk> streamTs_Pre($grpc.ServiceCall $call,
      $async.Future<$0.StreamH264Request> $request) async* {
    yield* streamTs($call, await $request);
  }

  $async.Stream<$0.TsChunk> streamTs(
      $grpc.ServiceCall call, $0.StreamH264Request request);

  $async.Future<$0.SnapshotReply> takeSnapshot_Pre($grpc.ServiceCall $call,
      $async.Future<$0.SnapshotRequest> $request) async {
    return takeSnapshot($call, await $request);
  }

  $async.Future<$0.SnapshotReply> takeSnapshot(
